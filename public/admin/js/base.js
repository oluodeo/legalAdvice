$(document).ready(function () {
    ...
    $(".layui-tab-title .layui-this").click(function () {
		...
		var home_tag = $(this).hasClass('home');
        if(!tag){
    ...
    $("#FullScreen").click(function () {
        ...
        if (fullscreenElement == null) {
            ...
            $(".layui-nav-item .img-FullScreen").attr('src','../admin/images/icon/fullscreen_exit.png')
        } else {
            exitFullScreen();
            $("#FullScreen span").html('全屏');
            $(".layui-nav-item .img-FullScreen").attr('src','../admin/images/icon/fullscreen.png')
        }
    });
...
function lockPage(){
    layer.open({
        ...
        '<div class="admin-header-lock-img"><img src="../admin/images/user.png"/></div>'+
